...
public class UsuarioDTO {
	...
	public UsuarioDTO(String email, String password, int t_Documento, int num_Documento, String p_Nombre,
			String s_Nombre, String p_Apellido, String s_Apellido, Date f_Nacimiento, int genero, int estadoCivil,
			int ciudadResidencia, String telefono) {
		this.email = email;
